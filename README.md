...
```python
# Change "yolo26m.pt" to "yolo26n.pt" for maximum speed
model = YOLO("yolo26m.pt")
```

- **yolo26n.pt** (Nano): Fastest, ideal for older CPUs or high FPS.
- **yolo26s.pt** (Small): Good balance between accuracy and speed.
- **yolo26m.pt** (Medium): Good accuracy, requires a strong GPU.
